...
CFLAGS = $(ARCH) -O2 -pipe -ftree-vectorize -flto=auto -ffat-lto-objects -std=gnu11 -Wall -march=native -fno-strict-aliasing -fno-strict-overflow -fwrapv -DAES=1 -DCOMMIT=\"${COMMIT}\" -D_GNU_SOURCE=1 -D_FILE_OFFSET_BITS=64
